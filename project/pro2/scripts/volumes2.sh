...
if [ "`echo -n $DEVICE_FS`" == "" ] ; then 
  ...
  lvcreate --name volume2 -l 100%FREE data
...
echo '/dev/data/volume2 /data ext4 defaults 0 0' >> /etc/fstab
...
echo "This is server *2* in AWS Region US-EAST-1 in AZ US-EAST-1B" > /data/www/html/index.html
